...
This is forked from [meertensm/amazon-mws](https://github.com/meertensm/amazon-mws).

### Installation:
```bash
$ composer require canopus0410/amazon-mws
```
...
$client = new Canpus0410\MWSClient([
    'Marketplace_Id' => '',
    'Seller_Id' => '',
    'Access_Key_ID' => '',
    'Secret_Access_Key' => '',
    'MWSAuthToken' => '' // Optional. Only use this option if you are a third party developer
]);
...
```php
$product = new Canpus0410\MWSProduct();
